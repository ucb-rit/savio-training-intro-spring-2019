...
The materials for this tutorial are available using git at the short URL [bit.do/S19Savio](http://bit.do/S19Savio), the  GitHub URL [https://github.com/ucb-rit/savio-training-intro-spring-2019](https://github.com/ucb-rit/savio-training-intro-spring-2019), or simply as a [zip file](https://github.com/ucb-rit/savio-training-intro-spring-2019/archive/master.zip).
